...
import { createTaxRecord, getTaxRecords } from "../controllers/taxController.js";
...
export default router; // This line fixes the 'does not provide an export named default' error